...
export const siteConfig = {
  businessName: "Compact Car Hire Ingham",
  companyTagline: "Practical self-drive hire across Ingham and beyond",
  legalBusinessName: "Compact Car Hire Ingham",
  locationName: "Ingham",
  siteUrl: "https://compactcarhireingham.co.uk",
  phone: "0203 909 9745",
  ...
  ui: {
    ...
    footerCopyrightLabel: "© 2026 Compact Car Hire Ingham. All rights reserved.",
  },
} as const
...
const homepageTokens: ContentTokenSet = {
  metadata: {
    title: "Compact Car Hire Ingham | Self-Drive Vehicle Hire",
    description: "Compact car hire in Ingham for local driving, station runs, airport trips and everyday travel, with vans, minibuses and trucks also available.",
  },
  ...
  heroTitle: "Compact car hire in Ingham made simple",
  heroDescription: "Compact car hire in Ingham for easy local driving, station runs, airport trips and everyday travel. We also offer vans, minibuses and trucks when you need more space or a different type of vehicle.",
  heroSecondaryActionLabel: "View vehicle options",
  mainServiceKicker: "Compact car hire",
  mainServiceTitle: "Self-drive compact cars for everyday travel in Ingham",
  mainServiceDescription: "Our core service is compact car hire for drivers who want something easy to manage, easy to park and comfortable enough for both local and regional travel. Small cars are a strong fit for everyday journeys around Ingham, from shopping trips and appointments to station runs, visiting family and covering temporary transport needs when your own car is off the road.\n\nWe focus on practical self-drive options rather than overcomplicated packages. That means a straightforward choice of compact vehicles including city-friendly models and slightly larger hatchbacks, with manual and automatic options available across the wider range. If your journey changes and you need extra room, we can also help with estates, larger cars and SUVs.\n\nBeyond compact cars, we support broader vehicle hire needs across Ingham with vans, minibuses and trucks. So whether you need a small runabout today or a larger vehicle for a different job next week, you can arrange it through the same business.",
  mainVehicles: [
    { body: "The Fiat 500 is ideal for quick local trips, easy parking and drivers who want a small car that feels simple to use around town.", alt: "Fiat 500 compact hire car for easy driving in Ingham" },
    { body: "A smart choice for convenient automatic driving, especially for short urban journeys, station pickups and everyday errands.", alt: "Hyundai i10 automatic compact hire car in Ingham" },
    { body: "The VW Golf gives you a little more cabin and boot space while still keeping the practical feel of a compact everyday hire car.", alt: "Volkswagen Golf hatchback available for hire in Ingham" },
    { body: "Useful for drivers who want the ease of an automatic with enough comfort for longer regional trips as well as local mileage.", alt: "Ford Focus automatic available for self-drive hire in Ingham" },
  ],
  whyChooseKicker: "Why choose us",
  whyChooseTitle: "A practical approach to self-drive hire in Ingham",
  whyChooseDescription: "Hiring a car should feel practical, not padded out with unnecessary sales talk. We focus on useful vehicles, clear communication and helping customers find a car that actually fits the journey they have planned in and around Ingham.",
  whyChooseItems: [
    ...
    { title: "Well suited to the area", body: "Ingham drivers often need vehicles for station access, motorway links and local errands, so our service is shaped around everyday local use." },
  ...
  additionalVehicles: [
    { body: "The Focus Estate is a useful step up when you want car-like driving with a larger boot for luggage, equipment or shopping runs.", alt: "Ford Focus Estate available for practical luggage and load space in Ingham" },
    { body: "A solid choice for longer motorway travel, business appointments and day trips where extra comfort matters.", alt: "Ford Mondeo saloon for longer road journeys from Ingham" },
    { body: "The automatic Mondeo suits drivers who want an easier drive in traffic while keeping the space and comfort of a larger car.", alt: "Ford Mondeo automatic for comfortable self-drive hire in Ingham" },
    { body: "Ideal when passengers and luggage both need room, making it well suited to airport runs, family travel and longer stays away.", alt: "Ford Mondeo Estate with extended luggage room for Ingham hires" },
    { body: "A practical SUV option with a higher driving position, useful for mixed local and regional journeys with passengers and bags.", alt: "Toyota RAV4 automatic SUV for flexible travel around Ingham" },
    { body: "For business travel or a more refined drive, the C Class Auto gives you a smarter cabin and easy motorway comfort.", alt: "Mercedes C Class automatic for executive car hire in Ingham" },
    { body: "The E Class Auto works well for longer business mileage, client travel and occasions where a more spacious executive car is preferred.", alt: "Mercedes E Class automatic executive vehicle hire in Ingham" },
    { body: "When you want extra presence, comfort and cabin space, the Range Rover is suited to higher-end journeys and larger personal loads.", alt: "Range Rover SUV hire for premium travel in Ingham" },
  ],
  featureCtaTitle: "Looking for the right vehicle in Ingham?",
  ...
  bottomCtaTitle: "Book compact car hire in Ingham with straightforward support",
  ...
  faqTitle: "Compact car hire FAQs for Ingham",
  faqs: [
    { question: "Why choose compact car hire in Ingham?", answer: "A compact car is often the easiest option for Ingham driving if you want simple parking, lighter fuel use and comfortable travel on local roads and short motorway runs." },
    { question: "Can I arrange compact car hire in Ingham at short notice?", answer: "Yes, we can help with short-notice availability in Ingham when vehicles are ready to go. The best option is to call and we will talk through what is currently available." },
    { question: "Do you only offer small cars in Ingham?", answer: "Yes. If you need more room than a small hatchback, we also offer estate cars, larger saloons, SUVs, vans, minibuses and trucks." },
    { question: "What are compact hire cars in Ingham usually used for?", answer: "Many customers use compact cars in Ingham for station pickups, airport journeys, visiting family, temporary vehicle cover and everyday local travel." },
    { question: "What do I need to collect my hire car in Ingham?", answer: "Bring your driving licence and any booking details when collecting in Ingham. If anything else is needed for your hire, we will confirm it before you travel." },
    { question: "Are automatic cars available for hire in Ingham?", answer: "Yes, subject to availability. If you prefer an easier drive for stop-start traffic or a more relaxed motorway run, ask us about our automatic options in Ingham." },
  ],
}

const vanHireTokens: ContentTokenSet = {
  metadata: {
    title: "Van Hire Ingham | Practical Vans for Moves, Deliveries and Trade",
    description: "Van hire in Ingham for home moves, deliveries, trade work and specialist jobs. Choose from compact vans, larger Transits, Lutons and more.",
  },
  heroImage: "/images/van_hire_image_1.jpeg",
  heroAlt: "Modern rental van being loaded with boxes outside a house",
  heroTitle: "Van hire in Ingham for work, moves and deliveries",
  heroDescription: "Practical van hire in Ingham for moves, trade work, deliveries, collections and business use. Choose from compact vans, larger panel vans and specialist vehicles to suit the job.",
  heroSecondaryActionLabel: "View van options",
  mainServiceKicker: "Ingham van fleet",
  mainServiceTitle: "Van hire for moves, work and transport needs",
  mainServiceDescription: "Our van hire service in Ingham is built around real day to day jobs. Some customers need a compact van for quick collections, storage runs or tool transport. Others need a larger panel van for furniture, stock, equipment or a full moving day. We also offer specialist options for more specific work, including dropsides, tippers, recovery vehicles and a cherry picker.\n\nWhether you are moving home, covering trade jobs, handling site work or making business deliveries, the right van makes a big difference. A smaller van can be easier to park and manoeuvre in tighter areas, while longer wheelbase and box vans give you the extra carrying room needed for larger loads. If you are unsure what will suit your route or cargo, we can help you narrow it down to a practical choice.",
  mainVehicles: [
  ...
  whyChooseDescription: "Van hire is rarely just about getting any vehicle. It is about getting one that actually works for the route, the load and the way the day is going to run. We keep that in mind when helping customers choose between compact vans, larger panel vans and specialist options in Ingham.",
  whyChooseItems: [
    ...
    { title: "Good regional access", body: "Ingham is well placed for local work and wider travel across the North West, making van hire useful for both short and longer runs." },
  ...
  featureCtaTitle: "Need van hire in Ingham?",
  featureCtaDescription: "Need a van for moving, deliveries or site work in Ingham? Speak to our team and we will help you choose a practical vehicle without the guesswork.",
  serviceAreasKicker: "Areas we cover",
  serviceAreasTitle: "Van hire in Ingham and nearby areas",
  serviceAreasDescription: "We support van hire from Ingham across surrounding towns and key route corridors, making it easier to cover local jobs, regional deliveries and one off transport tasks.",
  localRelevanceKicker: "Local van hire guidance",
  localRelevanceTitle: "Van hire that fits the way Ingham journeys actually work",
  localRelevanceDescription: "Van hire in Ingham suits a wide range of practical jobs, from moving between neighbourhoods to making collections across the wider North West. The town is well placed for local runs and regional travel alike, with strong links through the M6, M58 and A49. That makes it a useful base whether you are collecting furniture, transporting tools, delivering stock or handling a one off house move.\n\nThe key is matching the van to the work. Smaller vans are easier in tighter streets and busier built up areas, while longer and taller vans make better use of time when the load is bulky or awkward. For more specialist tasks, vehicles such as Lutons, dropsides, tippers and recovery vans can make the whole day more straightforward.\n\nIf you know the route, the type of load and how many stops are involved, choosing well becomes much easier. That is especially true around Ingham, where one hire might include residential streets, retail collections, motorway sections and site access all in the same journey.",
  localRelevanceBlocks: [
    { title: "Planning routes around Ingham and beyond", body: "Ingham works well for van hire because it sits between major routes rather than being cut off from them. If you are moving between Ingham town centre, Standish, Ashton-in-Makerfield or Hindley, a van gives you the flexibility to load once and keep the day moving. For wider trips, the M6, M58 and M61 links help with access across Lancashire, Greater Doncaster and Merseyside.\n\nIf your route includes industrial estates, retail parks or storage sites, it is worth thinking about turning space and loading access before you travel. A smaller van can be much easier around tighter streets and smaller forecourts, while a longer wheelbase van makes more sense when the load is bulky and the route is more straightforward." },
  ...
  faqTitle: "Common questions about van hire in Ingham",
  faqs: [
    ...
    { question: "Can I use the van for longer distance travel?", answer: "Yes, vans are commonly used for local work in Ingham as well as regional trips across Greater Doncaster, Lancashire, Merseyside and beyond. Let us know your route so we can help match the van to the journey." },
...
const minibusHireTokens: ContentTokenSet = {
  metadata: {
    title: "Minibus Hire Ingham | Group Travel Vehicle Hire",
    description: "Minibus hire in Ingham for airport transfers, family trips, events and group travel. Choose practical passenger vehicles for local and regional journeys.",
  },
  ...
  heroTitle: "Minibus Hire Ingham",
  heroDescription: "Practical minibus hire in Ingham for family trips, airport journeys, events, teams and group outings. Choose from flexible people carriers and larger minibuses.",
  heroSecondaryActionLabel: "View minibus options",
  mainServiceKicker: "Group vehicle hire",
  mainServiceTitle: "Ingham minibus hire for shared journeys of all kinds",
  mainServiceDescription: "Our Ingham minibus hire service is built around real group travel needs. That might mean a compact people carrier for family outings, a larger vehicle for a club trip, or a full minibus for airport transfers, weddings or event travel. The focus is on giving you enough seats, sensible luggage space and a vehicle that feels suited to the road plan ahead.\n\nWe support journeys that stay local as well as trips heading further afield across the North West and beyond. If you are organising transport for relatives, colleagues, sports teams or guests, we help you sort the practical side early so the travel day is easier to manage.",
  mainVehicles: [
    { body: "The Vauxhall Zafira 5 plus 2 is a flexible choice for families and small groups who need extra seats without stepping up to a full minibus.", alt: "Vauxhall Zafira 5 plus 2 people carrier for hire in Ingham" },
    { body: "The Galaxy 7 Seater Manual is well suited to airport runs, weekend breaks and group travel where passenger comfort matters.", alt: "Ford Galaxy 7 seater manual hire vehicle in Ingham" },
    { body: "The Galaxy 7 Seater Automatic offers the same roomy layout with easier driving for longer trips and mixed urban motorway routes.", alt: "Ford Galaxy 7 seater automatic people carrier for Ingham hire" },
    { body: "The 9 Seater Manual is a practical option for larger families, work outings and sports travel when one vehicle is easier than multiple cars.", alt: "9 seater manual minibus for group travel in Ingham" },
    { body: "The 9 Seater Automatic is a useful choice for shared travel where automatic driving and easy passenger loading are both important.", alt: "9 seater automatic minibus hire in Ingham" },
    { body: "The Ford 12 Seater works well for clubs, school outings, guest transport and group day trips with straightforward boarding and seating.", alt: "Ford 12 seater minibus available for hire in Ingham" },
    { body: "The Ford 15 Seater gives growing groups more room, making it a strong fit for event travel, team transport and organised outings.", alt: "Ford 15 seater minibus for larger groups in Ingham" },
    { body: "The Ford Minibus LITE 17 Seater is designed for larger groups needing extra capacity, with a layout aimed at drivers without D1 entitlement.", alt: "Ford Minibus Lite 17 seater no D1 hire vehicle in Ingham" },
    { body: "The Ford 17 Seater is a full-capacity option for major group movements where keeping everyone together is the priority.", alt: "Ford 17 seater minibus hire for group transport in Ingham" },
  ],
  whyChooseKicker: "Why choose us",
  whyChooseTitle: "Minibus hire planned around real journeys",
  whyChooseDescription: "Group travel can become awkward quickly if the vehicle is too small, the luggage space is overlooked or the route has not been thought through. We keep the process practical, helping customers in Ingham choose a passenger vehicle that genuinely fits the journey rather than simply filling seats.",
  whyChooseItems: [
    ...
    { title: "Ready for short and longer routes", body: "Our vehicles are suited to local Ingham travel as well as longer motorway journeys across the region." },
  ...
  faqs: [
    ...
    { question: "Do you provide minibuses for clubs and group outings in Ingham?", answer: "Yes, Ingham minibus hire is often a practical choice for school, club and team travel when everyone needs to arrive together." },
    { question: "How do I arrange minibus hire in Ingham?", answer: "Call us with your travel dates, group size and destination. We will talk you through the available minibus options and help you choose the best fit." },
  ],
}

const truckHireTokens: ContentTokenSet = {
  metadata: {
    title: "Truck Hire Ingham | Commercial Truck Rental",
    description: "Truck hire in Ingham for removals, deliveries, site work and commercial transport. Box, curtain side, dropside, tipper and tail lift truck options available.",
  },
  heroImage: "/images/truck_hire_image_1.jpeg",
  heroAlt: "Rigid hire truck parked at an industrial unit during a delivery job",
  heroTitle: "Truck Hire Ingham",
  heroDescription: "Truck hire in Ingham for removals, site work, larger deliveries and commercial transport. Choose from box trucks, curtain siders, tippers, recovery trucks and more.",
  heroSecondaryActionLabel: "View truck options",
  mainServiceKicker: "Commercial vehicle hire",
  mainServiceTitle: "Truck hire in Ingham for serious carrying work",
  mainServiceDescription: "Our truck hire service in Ingham is built for heavier transport tasks where a van is no longer enough. That includes removals support, site deliveries, stock movement, trade transport, recovery work and larger commercial loads. We offer a range of vehicle types so the choice is based on what the job actually needs rather than simply moving up to the biggest option.\n\nWhether you need a tail lift for boxed goods, a curtain side for easier loading access, a dropside for awkward materials or a tipper for site use, we help you make a practical choice. The aim is simple: a truck that suits the route, the payload and the working conditions on the day.",
  mainVehicles: [
    { body: "The Ford Luton 3.5 ton Tail Box Lift Truck is ideal for house moves, bulky goods and appliance transport where rear lift support makes loading easier.", alt: "Ford Luton 3.5 ton tail box lift truck for hire in Ingham" },
    { body: "The 3.5 Tonne Tipper Transit Truck is a practical choice for site clearance, loose materials, landscaping work and building jobs.", alt: "3.5 tonne tipper transit truck for site work in Ingham" },
    { body: "The 3.5 Tonne Recovery Truck suits vehicle transport and recovery tasks where secure loading and stable carriage are essential.", alt: "3.5 tonne recovery truck available in Ingham" },
    { body: "The 7.5 Tonne Box Truck With Tail Lift works well for larger deliveries, stock movement and removals support with easier rear loading.", alt: "7.5 tonne box truck with tail lift for Ingham deliveries" },
    { body: "The 7.5 Tonne Curtain Side Truck is well suited to pallet work and trade deliveries where side access speeds up loading and unloading.", alt: "7.5 tonne curtain side truck for loading access in Ingham" },
    { body: "The 7.5 Tonne Dropside Truck is useful for building materials, site equipment and awkward loads that benefit from open-sided access.", alt: "7.5 tonne dropside truck for materials transport in Ingham" },
    { body: "The 7.5 Tonne Tipper Truck is built for more demanding site work, waste movement and bulk material jobs that need higher carrying capacity.", alt: "7.5 tonne tipper truck for heavy site tasks in Ingham" },
    { body: "The 7.5 Tonne Sleeper Tail Lift Truck is suited to longer working runs where loading support and added driver practicality are both useful.", alt: "7.5 tonne sleeper tail lift truck for regional runs from Ingham" },
    { body: "The 18 Tonne Box Truck is designed for larger enclosed loads, distribution work and substantial stock movement.", alt: "18 tonne box truck for major commercial transport in Ingham" },
    { body: "The 18 Tonne Curtain Side Truck is a strong option for pallet networks, larger deliveries and trade loads needing side access.", alt: "18 tonne curtain side truck for freight movement in Ingham" },
    { body: "The 26 Tonne Curtain Side Truck suits higher-volume transport where larger payload capacity and side loading are both important.", alt: "26 tonne curtain side truck for major transport jobs in Ingham" },
    { body: "The 44 Tonne Sleeper Truck is designed for substantial haulage tasks where long-distance work and serious carrying capability are required.", alt: "44 tonne sleeper truck for long haul work from Ingham" },
  ],
  whyChooseKicker: "Why choose us",
  whyChooseTitle: "Truck hire guided by the job, not guesswork",
  whyChooseDescription: "Truck hire only works well when the details are right. Load shape, weight, unloading method, route access and site conditions all matter. We help customers in Ingham think through those practical points so the vehicle suits the task properly and the job can move forward with fewer problems on the day.",
  whyChooseItems: [
    ...
    { title: "Local and regional capability", body: "From local Ingham work to wider regional transport, our truck hire service supports jobs that need dependable carrying capacity." },
  ...
  faqs: [
    ...
    { question: "Can I hire a truck in Ingham for business use?", answer: "Yes, truck hire in Ingham is often used for site work, deliveries, removals support and commercial transport across local and regional routes." },
...
const location2Tokens: ContentTokenSet = {
  metadata: { title: "Compact Car Hire Gainsborough | Self-Drive Vehicle Hire", description: "Compact car hire in Gainsborough for local trips, station travel, business use, and everyday driving. Vans, minibuses, and trucks also available." },
  heroImage: "/images/nearby_location_image_2.jpeg",
  heroAlt: "Compact hire car on a suburban road in Gainsborough",
  heroTitle: "Compact car hire in Gainsborough",
  heroDescription: "Compact car hire in Gainsborough for local trips, station runs, business travel, and everyday journeys. Easy self-drive options with larger vehicles available too.",
  heroSecondaryActionLabel: "View Gainsborough vehicles",
  mainServiceKicker: "Gainsborough self-drive hire",
  mainServiceTitle: "Straightforward compact car hire for Gainsborough journeys",
  mainServiceDescription: "Our compact car hire service in Gainsborough is built for practical day to day travel. Whether you need a small car for local appointments, a reliable vehicle while your own is off the road, or something easy to drive for business and personal use, we can help you choose a suitable option.\n\nCompact cars are a natural fit for Gainsborough because they are easy to park, comfortable on short and medium journeys, and well suited to town traffic as well as wider North West routes. We also offer automatic options and a broader self-drive range including vans, minibuses, and trucks, so you can keep everything with one provider if your plans change.",
  mainVehicles: [
    { body: "The Fiat 500 is ideal for Gainsborough drivers who want a compact, easy to park car for local errands, short commutes, and simple everyday travel.", alt: "Fiat 500 hire car for compact driving in Gainsborough" },
    { body: "A Hyundai i10 Auto makes Gainsborough town driving easy, with the convenience of automatic transmission and a size that suits tighter parking spots.", alt: "Hyundai i10 automatic available for hire in Gainsborough" },
    { body: "The VW Golf is a strong all rounder for Gainsborough, giving you extra comfort and space for longer drives while staying manageable around town.", alt: "VW Golf self-drive hire option in Gainsborough" },
    { body: "If you want automatic driving with everyday practicality, the Focus Auto suits Gainsborough business use, family journeys, and regular regional travel.", alt: "Ford Focus automatic hire car in Gainsborough" },
  ],
  whyChooseKicker: "Why Gainsborough drivers choose us",
  whyChooseTitle: "A practical choice for Gainsborough vehicle hire",
  whyChooseDescription: "Hiring a car in Gainsborough should feel simple, not overcomplicated. We focus on practical vehicles, clear communication, and helping customers choose something that suits the roads they will actually be driving. That might mean a small city-friendly car, an automatic for easier stop start traffic, or a larger option when the journey needs more space.",
  whyChooseItems: [
    { title: "Town-friendly vehicles", body: "Our Gainsborough car hire range is centred on vehicles that are easy to live with on typical local journeys." },
    ...
    { title: "Automatic options available", body: "Automatic compact cars are available for Gainsborough drivers who want an easier drive in busier traffic." },
    ...
    { title: "Useful for many journey types", body: "The service suits personal travel, commuting, business use, and temporary replacement vehicle needs around Gainsborough." },
    { title: "Helpful booking support", body: "You can speak to us directly to check availability and narrow down the most suitable vehicle for Gainsborough travel." },
  ],
  additionalServicesKicker: "More vehicle hire options in Gainsborough",
  additionalServicesTitle: "Extra fleet options for Gainsborough travel",
  additionalServicesDescription: "If a compact car is not quite enough for your plans in Gainsborough, we also offer larger cars, estates, SUVs and premium automatics, plus vans, minibuses and trucks.",
  additionalVehicles: [
    { body: "Useful in Gainsborough when you want the feel of a car but need a larger boot for bags, equipment or shopping.", alt: "Ford Focus Estate for practical luggage space on Gainsborough hires" },
    { body: "A comfortable larger car for Gainsborough drivers making longer regional or motorway journeys.", alt: "Ford Mondeo saloon for longer journeys from Gainsborough" },
    { body: "A practical automatic option in Gainsborough for customers who want extra room and a more relaxed drive.", alt: "Ford Mondeo automatic available for hire in Gainsborough" },
    { body: "Well suited to Gainsborough airport journeys, family travel and trips where luggage space matters.", alt: "Ford Mondeo Estate with generous boot space for Gainsborough travel" },
    { body: "A RAV4 Auto gives Gainsborough drivers extra ride height and easy automatic driving for longer trips, family travel, and mixed urban and motorway use.", alt: "Toyota RAV4 automatic SUV hire in Gainsborough" },
    { body: "The C Class Auto suits Gainsborough business travel, client visits, and comfortable regional journeys when you want a more refined drive.", alt: "Mercedes C Class automatic available for hire in Gainsborough" },
    { body: "An E Class Auto is a strong choice in Gainsborough for executive travel, airport runs, and longer journeys where comfort matters.", alt: "Mercedes E Class automatic hire option in Gainsborough" },
    { body: "For Gainsborough drivers needing space, presence, and a higher driving position, the Range Rover fits family trips, events, and longer road journeys.", alt: "Range Rover available for self-drive hire in Gainsborough" },
  ],
  featureCtaTitle: "Check Gainsborough vehicle availability",
  featureCtaDescription: "Need a car for local travel in Gainsborough or a journey further afield? Get in touch and check which vehicles are available for your dates.",
  serviceAreasKicker: "Around Gainsborough",
  serviceAreasTitle: "Vehicle hire around Gainsborough and nearby routes",
  serviceAreasDescription: "We support Gainsborough and surrounding areas with compact car hire, while also offering access to vans, minibuses, and trucks when a different vehicle suits the job better.",
  localRelevanceKicker: "Driving in Gainsborough",
  localRelevanceTitle: "Why compact car hire works well in Gainsborough",
  localRelevanceDescription: "Gainsborough is the kind of place where a compact hire car makes immediate sense. Local driving can include town centre calls, retail trips, work appointments, school runs, and short notice travel, all mixed into one day. A smaller vehicle keeps those journeys easy to manage while still being comfortable enough for trips beyond town.\n\nIt also works well for people travelling in and out of Gainsborough for work, family visits, or onward connections. With practical road links across the wider area, compact car hire gives you enough flexibility for local movement without making parking and manoeuvring harder than it needs to be.",
  localRelevanceBlocks: [
    { title: "A good fit for everyday Gainsborough driving", body: "Driving around Gainsborough is usually straightforward when you pick a car that suits everyday local roads. Compact models are especially useful if your route includes the town centre, residential streets, or regular stops through areas where parking space can be tighter than expected.\n\nIf your day takes you towards the A58, the East Lancashire Road corridor, or links out towards Rainford and Haydock, a smaller car keeps things simple. It is often the sensible choice for a mix of errands, work appointments, and short regional drives." },
    { title: "Useful for station links and onward routes", body: "Gainsborough journeys often combine local access with wider travel, especially for people connecting to rail services, retail parks, and business addresses. A compact car works well if you are moving between the station area, retail trips, and onward routes without wanting the bulk of a larger vehicle.\n\nFor drivers heading towards the M62 or making regular trips across Merseyside and the North West, keeping the vehicle manageable matters. You still get enough comfort for longer runs, while making town parking and repeat stops less of a chore." },
    { title: "Easy to scale up if your plans change", body: "Not every Gainsborough booking is just about a small car. Sometimes plans shift from a simple local run to carrying more passengers or more load space than expected. That is why it helps to use a hire company that can also assist with vans, minibuses, and trucks when needed.\n\nIf you start with compact car hire in Gainsborough but realise the job is bigger, it is easier to adjust when the wider fleet is available. That keeps your travel plans practical without overcomplicating the booking." },
  ],
  bottomCtaTitle: "Book your Gainsborough hire vehicle",
  bottomCtaDescription: "If you need compact car hire in Gainsborough, talk to our team and we will help you find a practical vehicle for the journey ahead.",
  faqKicker: "Gainsborough hire questions",
  faqTitle: "Compact car hire FAQs for Gainsborough",
  faqs: [
    { question: "Can I arrange compact car hire in Gainsborough at short notice?", answer: "Yes, we can help arrange compact car hire for Gainsborough when you need a practical vehicle for local driving, station journeys, or onward travel. Availability depends on the vehicle and timing, so it is best to check with us directly." },
    { question: "Why choose a compact car for driving in Gainsborough?", answer: "Compact cars are often a good fit for Gainsborough because they are easier to park, simple to handle on local roads, and well suited to everyday journeys around town and beyond." },
    { question: "Do you offer automatic cars for Gainsborough hires?", answer: "Yes, Gainsborough customers can ask about automatic compact car options. They are especially useful for town driving, busier junctions, and stop start traffic." },
    { question: "What kind of journeys are compact hire cars used for in Gainsborough?", answer: "Many Gainsborough bookings are for local appointments, visiting family, temporary vehicle cover, shopping trips, and rail connections, but the right car also works well for longer regional travel." },
    { question: "Can I hire more than just a compact car in Gainsborough?", answer: "Yes, alongside compact cars in Gainsborough we also offer vans, minibuses, and trucks, so if your plans change we can help you look at a more suitable vehicle." },
    { question: "How do I choose the right hire car for Gainsborough travel?", answer: "When booking your Gainsborough hire, tell us about passenger numbers, luggage, whether you want manual or automatic, and the type of journey you are planning. That helps us suggest the best option." },
  ],
}
...
const location4Tokens: ContentTokenSet = {
  metadata: { title: "Compact Car Hire Market Rasen | Vehicle Hire Market Rasen", description: "Compact car hire in Market Rasen for local travel, station runs and regional driving, with vans, minibuses and trucks also available when needed." },
  heroImage: "/images/nearby_location_image_2.jpeg",
  heroAlt: "Compact hire car on a business-travel route in Market Rasen",
  heroTitle: "Compact Car Hire in Market Rasen",
  heroDescription: "Compact car hire in Market Rasen for everyday travel, station pickups, business meetings and regional journeys. Easy-to-drive vehicles with support from a practical local team.",
  heroSecondaryActionLabel: "View vehicle options",
  mainServiceKicker: "Market Rasen compact car hire",
  mainServiceTitle: "Practical car hire for Market Rasen journeys",
  mainServiceDescription: "Compact car hire in Market Rasen suits everything from station runs and business travel to shopping trips and weekend plans. A smaller car is easy to handle around the town centre, residential streets and busy retail areas, while still being comfortable for longer journeys using the M6, M62 and A49. If you need a straightforward self-drive option for local travel in Market Rasen, we offer practical cars that are simple to park, economical on everyday mileage and well suited to solo drivers, couples and small families.",
  mainVehicles: [
    { body: "The Fiat 500 is a smart fit for Market Rasen town driving, short local trips and easy parking near busy central areas.", alt: "Fiat 500 compact hire car for Market Rasen" },
    { body: "The Hyundai i10 Auto is ideal for drivers who want a small automatic for comfortable local travel around Market Rasen.", alt: "Hyundai i10 automatic hire car for Market Rasen" },
    { body: "The VW Golf offers extra room and motorway confidence while still staying practical for everyday use in Market Rasen.", alt: "VW Golf hire car for Market Rasen travel" },
    { body: "The Focus Auto suits mixed Market Rasen journeys, giving you automatic ease for commuting, business calls and regional runs.", alt: "Ford Focus automatic hire car in Market Rasen" },
  ],
  whyChooseKicker: "Why Market Rasen drivers call us",
  whyChooseTitle: "A practical choice for compact car hire in Market Rasen",
  whyChooseDescription: "Hiring a compact car in Market Rasen should feel practical, not overcomplicated. We focus on useful vehicles, clear guidance and a service that works for real journeys, whether you are travelling locally, heading out on business or connecting with wider routes across the region.",
  whyChooseItems: [
    { title: "Compact cars that fit the area", body: "Choose a smaller car that suits town driving, station access and everyday travel around Market Rasen." },
    ...
    { title: "Useful choice across the fleet", body: "Automatic and manual compact options make it easier to book a car you feel comfortable driving in Market Rasen." },
    { title: "Ready for local and regional use", body: "From local errands to regional travel, our vehicles are suited to the mixed driving patterns common around Market Rasen." },
    { title: "Wider hire options available", body: "If your plans expand beyond compact car hire in Market Rasen, we can also arrange larger vehicles from the same fleet." },
    { title: "Easy to arrange", body: "We keep the process clear and practical so booking the right vehicle in Market Rasen feels simple." },
  ],
  additionalServicesKicker: "More than compact cars in Market Rasen",
  additionalServicesTitle: "Broader vehicle choice for Market Rasen travel",
  additionalServicesDescription: "Market Rasen journeys vary from local calls and station runs to business travel and longer motorway driving, so it helps to have more than one option. Alongside compact cars, we can help with larger cars plus vans, minibuses, and trucks where the journey calls for them.",
  additionalVehicles: [
    { body: "The Focus Estate gives Market Rasen drivers extra luggage room for business travel, family trips, and longer journeys without moving into a much larger vehicle.", alt: "Ford Focus Estate hire car for Market Rasen journeys" },
    { body: "A Mondeo suits Market Rasen customers who want a comfortable car for regular motorway use, client visits, or longer day trips.", alt: "Ford Mondeo available for hire in Market Rasen" },
    { body: "The Mondeo Auto is a practical choice in Market Rasen for drivers who want added cabin space and relaxed automatic driving.", alt: "Ford Mondeo automatic self-drive hire in Market Rasen" },
    { body: "For Market Rasen travel that needs both passenger comfort and strong boot capacity, the Mondeo Estate is a dependable all round option.", alt: "Ford Mondeo Estate available for Market Rasen hire" },
    { body: "A RAV4 Auto works well for Market Rasen drivers wanting a higher seating position, flexible space, and comfort for regional travel.", alt: "Toyota RAV4 automatic hire vehicle in Market Rasen" },
    { body: "The C Class Auto is well suited to Market Rasen business use, executive travel, and professional journeys across the North West.", alt: "Mercedes C Class automatic available for hire in Market Rasen" },
    { body: "An E Class Auto gives Market Rasen customers extra comfort for longer motorway routes, airport runs, and higher end travel needs.", alt: "Mercedes E Class automatic hire option in Market Rasen" },
    { body: "The Range Rover suits Market Rasen bookings where you want generous space, a raised driving position, and strong comfort for family or event travel.", alt: "Range Rover available for self-drive hire in Market Rasen" },
  ],
  featureCtaTitle: "Need compact car hire in Market Rasen?",
  featureCtaDescription: "If you need a practical compact car in Market Rasen, speak to our team and we will help you choose the right vehicle for local trips, business travel or onward journeys.",
  serviceAreasKicker: "Around Market Rasen",
  serviceAreasTitle: "Vehicle hire in and around Market Rasen",
  serviceAreasDescription: "We provide compact car hire across Market Rasen and nearby areas, with support for drivers who need an easy local vehicle as well as access to vans, minibuses and trucks.",
  localRelevanceKicker: "Driving in Market Rasen",
  localRelevanceTitle: "Why compact car hire works well in Market Rasen",
  localRelevanceDescription: "Market Rasen is the kind of place where a compact car makes immediate sense. The town sits between major motorway links and busy local roads, but many day-to-day journeys still depend on being able to park easily, turn around quickly and move between central streets, residential areas and business locations without hassle. For that kind of driving, a smaller car is often the most practical choice.\n\nIt is also a town with varied travel patterns. Some drivers need a car for rail connections, some for office visits, and others for errands, family travel or short regional trips. Compact car hire in Market Rasen suits that mix well, giving you a vehicle that feels comfortable on local roads while still being ready for travel farther out when needed.",
  localRelevanceBlocks: [
    { title: "Driving around central Market Rasen", body: "Market Rasen works well with a compact car because so many journeys involve switching between town-centre streets, retail parks and motorway links. If you are heading near Golden Square, the Cultural Quarter or the station approaches, a smaller vehicle is simply easier to place and easier to live with through a busy day.\n\nThe road network also means you can be in and out quickly when plans change. Routes such as the A49, A50 and A57 connect different parts of Market Rasen efficiently, while the M62 and M6 are close enough to make regional travel straightforward without needing a larger car." },
    { title: "Stations, offices and onward travel", body: "Compact car hire is especially useful in Market Rasen if your day includes rail connections or office visits. Around Market Rasen Central and Market Rasen Bank Quay, access can feel more manageable in a smaller vehicle, particularly when you are handling luggage, collecting colleagues or making a quick onward trip after arriving by train.\n\nFor business users travelling to Birchwood or visiting customers across the wider area, a compact hatchback gives a practical balance of comfort and manoeuvrability. It is well suited to mixed driving, from town traffic to short motorway stretches, without feeling oversized for tighter parking areas." },
    { title: "Planning practical journeys from Market Rasen", body: "Market Rasen is often a link point rather than a final stop, which makes choosing the right vehicle important. If your plans include shopping collections, family visits or leisure trips out toward surrounding routes, a compact car keeps things simple while still offering enough room for the usual bags, cases and day-to-day items.\n\nIt also helps to think about timing. Roads around key retail and commuter zones can feel busier at peak periods, so collecting the right car for the job can make the whole journey smoother. If you later need extra carrying space, we can also help with vans, minibuses and trucks from the wider fleet." },
  ],
  bottomCtaTitle: "Book a hire car for Market Rasen",
  bottomCtaDescription: "Need compact car hire in Market Rasen? Get in touch and we will help you choose a practical self-drive vehicle for town, business, or motorway use.",
  faqKicker: "Market Rasen FAQs",
  faqTitle: "Market Rasen compact car hire questions",
  faqs: [
    { question: "What is compact car hire in Market Rasen useful for?", answer: "Compact car hire in Market Rasen is ideal for local business travel, station connections, shopping trips, commuting, and everyday journeys where easy parking matters." },
    { question: "Can I hire an automatic car in Market Rasen?", answer: "Yes, automatic options are available for Market Rasen hires, which can be especially helpful if your route includes frequent junctions, queues, or regular town driving." },
    { question: "Why choose a compact hire car for Market Rasen travel?", answer: "A compact car makes sense in Market Rasen because it is easy to handle in busy areas while still being comfortable for trips out on the main road network." },
    { question: "Can I use a compact hire car in Market Rasen for business travel?", answer: "Yes, if your Market Rasen plans involve more luggage, more passengers, or a different kind of journey, we can also help with larger cars and other vehicle types." },
    { question: "Why choose a compact car for driving in Market Rasen?", answer: "A compact car suits many Market Rasen journeys because it is easier to park around the town centre, convenient for station runs, and comfortable for local and regional travel." },
    { question: "Do you offer other vehicle hire services in Market Rasen?", answer: "Yes. Alongside compact car hire in Market Rasen, we can also help with vans, minibuses and trucks when your plans need more space or carrying capacity." },
  ],
}
...
const location6Tokens: ContentTokenSet = {
  metadata: { title: "Compact Car Hire Grimsby | Small Car Rental Options", description: "Compact car hire in Grimsby for local trips, business travel and onward journeys. Practical self-drive vehicles with wider fleet options available." },
  heroImage: "/images/nearby_location_image_1.jpeg",
  heroAlt: "Compact hire car on a local access road in Grimsby",
  heroTitle: "Compact Car Hire in Grimsby",
  heroDescription: "Compact car hire in Grimsby for local travel, work use, shopping trips and onward journeys. Practical vehicles that suit everyday driving without unnecessary size.",
  heroSecondaryActionLabel: "See compact car choices",
  mainServiceKicker: "Compact cars in Grimsby",
  mainServiceTitle: "Straightforward compact car hire in Grimsby",
  mainServiceDescription: "If you need compact car hire in Grimsby, we offer practical vehicles that make local trips simpler. Small cars are well suited to everyday driving around residential areas, retail parks and business routes where easy parking and smooth manoeuvring matter. Whether you are heading to meetings, sorting family travel, covering a temporary vehicle gap or planning a longer run beyond town, a compact hire car gives you useful flexibility without taking up more space than you need.\n\nOur compact range covers straightforward town driving as well as comfortable travel for motorway connections. That means you can choose a city-friendly option for short local errands or a larger hatchback for regular runs in and out of Grimsby. We also offer vans, minibuses and trucks if your plans change and you need more carrying space or passenger room.",
  mainVehicles: [
    { body: "A neat choice for short trips around Grimsby, with easy handling for local roads, shopping runs and everyday travel.", alt: "Fiat 500 compact hire car for Grimsby local driving" },
    { body: "An automatic compact car that keeps town driving simple, especially useful for stop start traffic and quick local errands.", alt: "Hyundai i10 automatic compact hire car in Grimsby" },
    { body: "A solid all rounder for Grimsby drivers who want compact size with extra comfort for commuting and regional journeys.", alt: "VW Golf compact hatchback hire car in Grimsby" },
    { body: "A practical automatic for longer drives from Grimsby, giving you relaxed road manners and useful cabin space.", alt: "Ford Focus automatic hire car for Grimsby journeys" },
  ],
  whyChooseKicker: "Why Grimsby drivers choose us",
  whyChooseTitle: "A practical option for Grimsby car hire",
  whyChooseDescription: "Grimsby journeys can vary quickly between local roads, retail access routes and motorway links, so it helps to hire a car that feels easy to live with. We keep the offer practical, with compact vehicles that are simple to drive, sensible for everyday plans and backed by a wider self-drive fleet when you need something larger.",
  whyChooseItems: [
    { title: "Useful for town driving", body: "A compact car is easier to place in busier parts of Grimsby, especially when your day includes several short stops." },
    { title: "Choice that fits the trip", body: "Our range includes smaller options for local use and larger hatchbacks when you want extra room for regular journeys from Grimsby." },
    ...
    { title: "Good for daily schedules", body: "Compact cars are a practical match for station drop offs, work appointments and planned travel around Grimsby." },
  ...
  additionalServicesKicker: "More vehicle hire in Grimsby",
  additionalServicesTitle: "Additional vehicle hire options for Grimsby",
  additionalServicesDescription: "Compact cars are often the right match for Grimsby, but not every journey is the same. If you need more room, more comfort or a different type of vehicle, our wider fleet is available too.",
  additionalVehicles: [
    { body: "The Focus Estate adds flexible boot space for Grimsby journeys that involve luggage, work gear or larger shopping loads.", alt: "Ford Focus Estate hire car for Grimsby" },
    { body: "The Mondeo is a comfortable step up for Grimsby drivers covering longer regional miles.", alt: "Ford Mondeo hire vehicle in Grimsby" },
    { body: "The Mondeo Auto suits Grimsby bookings where you want easy automatic driving and a more spacious cabin.", alt: "Ford Mondeo automatic hire car for Grimsby" },
    { body: "The Mondeo Estate is useful for Grimsby travel that combines passengers with larger bags or equipment.", alt: "Ford Mondeo Estate hire car in Grimsby" },
    { body: "The RAV4 Auto offers extra versatility and a higher seating position for varied Grimsby journeys.", alt: "Toyota RAV4 automatic hire vehicle for Grimsby" },
    { body: "The C Class Auto is a refined option for Grimsby business travel and more comfort-focused trips.", alt: "Mercedes C Class automatic hire car in Grimsby" },
    { body: "The E Class Auto gives Grimsby drivers extra room and a smooth drive for longer road use.", alt: "Mercedes E Class automatic hire car for Grimsby" },
    { body: "The Range Rover is suited to Grimsby bookings where space, comfort and a more substantial vehicle are preferred.", alt: "Range Rover hire vehicle for Grimsby travel" },
  ],
  featureCtaTitle: "Arrange compact car hire in Grimsby",
  featureCtaDescription: "Need a small, easy-to-manage vehicle in Grimsby? Contact us and we will help you choose the right compact car for the way you travel.",
  serviceAreasKicker: "Grimsby coverage",
  serviceAreasTitle: "Serving Grimsby and nearby travel routes",
  serviceAreasDescription: "We support Grimsby and surrounding routes with compact car hire that works for local driving, station runs, business travel and wider self-drive needs.",
  localRelevanceKicker: "Local driving in Grimsby",
  localRelevanceTitle: "Compact car hire that suits Grimsby journeys",
  localRelevanceDescription: "Grimsby is a practical place to hire a compact car because many journeys are functional rather than flashy. Drivers often need to get between residential areas, retail destinations, work locations and connecting routes without making the trip more complicated than it needs to be. A compact vehicle does that job well, giving you simple local usability and enough comfort for longer miles.\n\nThe town's road layout also makes vehicle size worth thinking about. If your day includes repeated stops, everyday parking and quick turns onto major routes, a smaller car can be the most useful option overall. It fits the way many people travel in Grimsby: flexible, efficient and easy to manage.",
  localRelevanceBlocks: [
    { title: "Well suited to local travel patterns", body: "Grimsby is built around movement between neighbourhoods, shopping areas and major connecting roads, which is one reason compact cars work so well here. A smaller vehicle is easy to manage on routine local runs and still comfortable enough for longer journeys once you leave town.\n\nAccess to routes such as the M58 and A570 also means many trips quickly move from local roads to faster stretches. That makes compact car hire in Grimsby a useful balance: practical in everyday settings, but not limited when the journey opens out." },
    { title: "Useful for errands, work and short hops", body: "Many Grimsby bookings are about convenience rather than occasion travel. You may need a car for appointments, work visits, family travel or straightforward errands, and in those cases a compact vehicle usually feels like the right fit. It is easier to park, easier to turn around and easier to use over multiple stops in one day.\n\nThat matters around busier local destinations and shopping areas where space can be tighter and journeys more stop-start than open-road driving. A small hatchback can make those ordinary tasks feel less effort than using a larger vehicle you do not really need." },
    { title: "Ready for local use and regional links", body: "Grimsby also sits in a position where outward travel is common. If your plans involve reaching business sites, connecting with nearby towns or covering regional miles, a compact car remains a sensible choice because it is comfortable enough for the road while still being manageable back on local streets.\n\nWhen the journey changes shape and you need more carrying space, the wider fleet is there to support that next step. We can help move from compact car hire in Grimsby to larger cars, vans, minibuses or trucks depending on what the day actually requires." },
  ],
  bottomCtaTitle: "Speak to us about Grimsby car hire",
  bottomCtaDescription: "Arrange compact car hire in Grimsby with a team that focuses on practical vehicles and straightforward support.",
  faqKicker: "Grimsby FAQs",
  faqTitle: "Compact car hire questions for Grimsby",
  faqs: [
    { question: "Do you provide compact car hire in Grimsby?", answer: "Yes, we offer compact car hire in Grimsby for local driving, everyday travel and wider regional journeys." },
    { question: "Why hire a compact car in Grimsby?", answer: "Compact cars work well in Grimsby because they are practical for local roads, easier to park and comfortable for routine journeys." },
    { question: "Are automatic hire cars available in Grimsby?", answer: "Yes, we can help with automatic compact hire cars in Grimsby if that is your preferred driving option." },
    { question: "Is compact car hire in Grimsby suitable for work use?", answer: "Yes, many drivers use compact car hire in Grimsby for work visits, appointments, commuting and everyday business travel." },
    { question: "Can I upgrade to a larger vehicle in Grimsby?", answer: "If your Grimsby journey needs more room than a compact car provides, we can also assist with larger cars, vans, minibuses and trucks." },
    { question: "How do I pick the best hire car for Grimsby?", answer: "Tell us how you expect to use the vehicle in Grimsby and we will help point you toward the most suitable option in the fleet." },
  ],
}

const location7Tokens: ContentTokenSet = {
  metadata: { title: "Compact Car Hire Newark | Small Car Rental for City and Regional Travel", description: "Compact car hire in Newark for local trips, business travel and easy regional driving. Small cars plus access to vans, minibuses and trucks." },
  heroImage: "/images/nearby_location_image_2.jpeg",
  heroAlt: "Compact hire car on a regional access road in Newark",
  heroTitle: "Compact Car Hire in Newark",
  heroDescription: "Practical compact car hire in Newark for commuting, city-centre trips, business travel and easy regional driving. A smart choice when you want a vehicle that is simple to park and comfortable on the move.",
  heroSecondaryActionLabel: "View vehicle options",
  mainServiceKicker: "Newark compact car hire",
  mainServiceTitle: "Small cars that suit the way Newark journeys actually work",
  mainServiceDescription: "Our Newark compact car hire service is built around everyday usability. Whether you need something for local appointments, work travel, visiting family, university-related journeys or onward trips beyond the city, a smaller vehicle keeps things straightforward. Compact cars are easier to manoeuvre in busier areas, simpler to park and well suited to mixed driving where your route may include central streets, dual carriageways and motorway sections.\n\nNewark is the kind of place where that flexibility matters. One journey might involve station access, another a run across town, and the next a motorway connection heading out of the area. A compact hire car gives you practical comfort without feeling oversized for the job. If you need more space than a standard small car, we can also help with larger cars and other vehicle types through the wider fleet.",
  mainVehicles: [
  ...
  whyChooseKicker: "Why Newark customers book with us",
  whyChooseTitle: "A practical choice for compact car hire in Newark",
  whyChooseDescription: "Newark journeys can change quickly between city traffic, retail access, station approaches and motorway travel, so the right hire vehicle needs to feel adaptable rather than awkward. We focus on straightforward compact car options that work for practical day-to-day use.\n\nCustomers in Newark also value having access to a broader fleet when plans shift. If a small car is right today but a van, minibus or larger vehicle is needed next time, the wider service makes that easy to arrange through one team.",
  whyChooseItems: [
  ...
  additionalServicesKicker: "More Newark vehicle options",
  additionalServicesTitle: "Wider vehicle hire choices for Newark journeys",
  additionalServicesDescription: "Alongside compact car hire in Newark, we also offer larger cars, estates, SUVs and executive models when your journey needs more room, extra comfort or stronger motorway presence. Van, minibus and truck hire can also be arranged through the wider fleet.",
  additionalVehicles: [
  ...
  featureCtaTitle: "Check compact car availability in Newark",
  featureCtaDescription: "Need a small car for Newark driving, station access or a straightforward motorway run? Speak to us and we will help you find a practical compact hire option.",
  serviceAreasKicker: "Around Newark",
  serviceAreasTitle: "Vehicle hire serving Newark and nearby routes",
  serviceAreasDescription: "We support customers travelling in and around Newark, with compact car hire that fits local driving as well as onward regional routes. The wider service also covers vans, minibuses and trucks when a larger vehicle is needed.",
  localRelevanceKicker: "Driving in Newark",
  localRelevanceTitle: "Why compact car hire works well in Newark",
  localRelevanceDescription: "Newark suits compact car hire because so many journeys mix city-centre traffic with quick access to major routes. A smaller car is useful when you are heading through busy areas near Newark Railway Station, moving around the ring-road sections, or fitting into tighter parking around shops, offices and residential streets. It gives you enough comfort for longer drives while staying easy to place in day-to-day traffic.\n\nThe city also works well as a base for wider travel. With the A59, A6, M6 and M55 all playing a part in local movement, a compact vehicle makes sense for customers who want a car that feels manageable in town but still settled on regional roads. That balance is often what Newark drivers and visitors need most.",
  localRelevanceBlocks: [
  ...
  bottomCtaTitle: "Book your Newark compact car hire",
  bottomCtaDescription: "If you need a compact car in Newark for business travel, station runs, family visits or general local driving, contact the team and we will help you choose a suitable vehicle.",
  faqKicker: "Newark hire FAQs",
  faqTitle: "Common questions about compact car hire in Newark",
  faqs: [
    { question: "Can I hire a compact car for local and longer trips from Newark?", answer: "Yes, we can help arrange compact car hire for Newark journeys ranging from local errands and work appointments to longer regional travel. Let us know where you plan to drive and we can suggest a suitable option." },
    { question: "Why choose a compact car for driving in Newark?", answer: "A compact car is often a good fit for Newark because it is easier to handle around the city centre, station approaches, retail parking and busy routes feeding onto the A59 and M6." },
    { question: "Do you offer automatic compact cars in Newark?", answer: "Yes, automatic compact car availability can be checked for Newark bookings. If you prefer automatic driving for commuting, town traffic or motorway work, ask when you contact us." },
    { question: "Is Newark compact car hire suitable for business use?", answer: "Many customers use Newark compact car hire for business meetings, visiting clients, station pickups, university-related travel and convenient day-to-day driving where a smaller vehicle makes access easier." },
    { question: "Can I arrange other vehicle hire in Newark as well as compact cars?", answer: "Yes, we also support Newark customers who need vans, minibuses or trucks. If your plans change from a small car to something larger, we can talk through the wider fleet." },
    { question: "How do I book compact car hire in Newark?", answer: "The quickest way to arrange Newark compact car hire is to call with your preferred timing, driving requirements and any route plans. We will then help match the booking to the right vehicle." },
  ],
}

const location8Tokens: ContentTokenSet = {
  metadata: { title: "Compact Car Hire Doncaster | Small Car Rental for City Travel", description: "Compact car hire in Doncaster for city journeys, business travel and easy regional driving. Small cars backed by a wider vehicle hire fleet." },
  heroImage: "/images/nearby_location_image_1.jpeg",
  heroAlt: "Compact hire car approaching a busy urban route in Doncaster",
  heroTitle: "Compact Car Hire in Doncaster",
  heroDescription: "Compact car hire in Doncaster for city driving, work travel, station access and flexible regional trips. A sensible option when you want easy handling without giving up everyday comfort.",
  heroSecondaryActionLabel: "See available vehicles",
  mainServiceKicker: "Doncaster compact car hire",
  mainServiceTitle: "Smart small-car hire for Doncaster travel",
  mainServiceDescription: "Our Doncaster compact car hire service is designed for drivers who need a vehicle that works in real city conditions. Whether you are travelling for meetings, visiting family, getting around central districts or connecting onto major regional routes, a compact car gives you the flexibility to move without feeling over-committed to a larger vehicle. It is a practical fit for stop-start traffic, tighter parking and mixed-use journeys across the city.\n\nDoncaster driving can change quickly from urban streets to major roads, and that is exactly where compact cars perform well. They are easy to place in crowded areas yet comfortable enough for longer motorway sections when your plans extend beyond the city. If you need more carrying capacity or passenger room, we can also support Doncaster customers with the wider fleet.",
  mainVehicles: [
    { body: "A neat choice for Doncaster when you want easy parking, light steering and a compact footprint for local streets, quick errands and city-centre trips.", alt: "Fiat 500 compact hire car for Doncaster driving" },
    { body: "The Hyundai i10 Auto suits Doncaster drivers who want straightforward automatic driving for commuting, station runs and everyday travel around the city.", alt: "Hyundai i10 automatic city car available for Doncaster hire" },
    { body: "A practical all-rounder for Doncaster, with extra comfort and space for longer drives, business travel and weekends away without feeling oversized.", alt: "VW Golf hatchback hire car for Doncaster journeys" },
    { body: "The Focus Auto is well suited to Doncaster traffic, giving you automatic convenience, solid motorway comfort and useful room for passengers or luggage.", alt: "Ford Focus automatic hire car in Doncaster" },
  ],
  whyChooseKicker: "Why Doncaster drivers choose us",
  whyChooseTitle: "Why choose our compact car hire in Doncaster",
  whyChooseDescription: "When you need compact car hire in Doncaster, the details matter. You want a vehicle that makes city driving simpler, collection straightforward and onward travel less of a faff. Our compact range is chosen for practical day-to-day use, whether you are staying local or heading out across Greater Doncaster.",
  whyChooseItems: [
    ...
    { title: "Practical hire guidance", body: "Useful if you are heading into Doncaster for work, shopping, social plans or station connections and want a car that is simple to handle in busy streets." },
    { title: "Wider vehicle options", body: "If you need something beyond a compact car in Doncaster, we can also help with vans, minibuses and trucks through the wider fleet." },
  ],
  additionalServicesKicker: "More Doncaster vehicle choices",
  additionalServicesTitle: "Extra hire options beyond compact cars in Doncaster",
  additionalServicesDescription: "As well as compact car hire in Doncaster, we can arrange larger saloons, estates, SUVs and executive vehicles for journeys that call for extra room or added comfort. The wider fleet also includes vans, minibuses and trucks for more demanding transport needs.",
  additionalVehicles: [
  ...
  featureCtaTitle: "Check Doncaster compact car options",
  featureCtaDescription: "Need a small car that suits Doncaster traffic, business travel and easier parking? Contact us to check compact car availability for your Doncaster journey.",
  serviceAreasKicker: "Across Doncaster",
  serviceAreasTitle: "Vehicle hire covering Doncaster and surrounding routes",
  serviceAreasDescription: "We provide compact car hire for Doncaster travel, covering city-centre use, local districts and onward regional routes. If you need something larger, vans, minibuses and trucks are also available through the wider service.",
  localRelevanceKicker: "Doncaster driving guide",
  localRelevanceTitle: "Why compact car hire makes sense in Doncaster",
  localRelevanceDescription: "Doncaster is one of the clearest places to see the value of a compact hire car. Journeys often involve traffic-heavy corridors, city-centre turns, controlled parking areas and quick changes between urban streets and major road links. A smaller vehicle takes the pressure out of that. It is easier to manoeuvre around the inner districts, simpler to park and well suited to drivers who want a car that feels calm rather than bulky in busier conditions.\n\nThe city also demands flexibility. One trip may keep you near Doncaster Piccadilly or Oxford Road, while the next heads out via the Mancunian Way, M60 or M62. Compact cars work well because they bridge both styles of travel. You get something practical for dense city movement but still comfortable enough for longer runs beyond Doncaster.",
  localRelevanceBlocks: [
  ...
  bottomCtaTitle: "Arrange your Doncaster compact car hire",
  bottomCtaDescription: "If you need a compact car in Doncaster for work, city travel, station pickups or a wider regional journey, get in touch and we will help you line up the right vehicle.",
  faqKicker: "Doncaster hire FAQs",
  faqTitle: "Helpful answers for compact car hire in Doncaster",
  faqs: [
    { question: "Why is a compact car a good option for driving in Doncaster?", answer: "A compact car is often ideal for Doncaster because it is easier to handle in dense traffic, city-centre parking areas, residential streets and busy approach roads while still being comfortable for longer drives." },
    { question: "Can I book compact car hire in Doncaster for business use?", answer: "Yes, Doncaster compact car hire works well for business travel, meetings, office visits, client appointments and general professional use where you want a vehicle that is tidy, practical and easy to park." },
    { question: "Do you have automatic compact cars available in Doncaster?", answer: "Automatic compact car availability can be checked for Doncaster bookings. If you expect heavier traffic or simply prefer automatic driving in the city, let us know when you enquire." },
    { question: "Is compact car hire in Doncaster useful for station and city-centre travel?", answer: "Yes, many customers use Doncaster compact car hire for rail station access, city-centre stays and straightforward onward travel. A smaller car is often easier to live with around busy arrival and parking points." },
    { question: "Can I arrange other vehicle hire in Doncaster through the same service?", answer: "Yes, alongside compact cars we can also help Doncaster customers with vans, minibuses and trucks when the journey or load calls for something larger." },
    { question: "How do I arrange compact car hire in Doncaster?", answer: "To book compact car hire in Doncaster, call with your travel dates, preferred vehicle type and any key route details. We will help you choose a suitable option for the journey." },
  ],
}
